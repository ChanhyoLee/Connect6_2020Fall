...
//		robot.mouseRelease(InputEvent.BUTTON1_DOWN_MASK);//좌클릭 업
	...
	public static double calculateDoubleMove_score(Moves myMoves, int player) { //두 수의 점수 최대값을 계산 
		int board[][] = new int[19][19];
		CheckBoard.deepCopy_Board(CheckBoard.tile_board, board);
	    double score = 0.0;
	...
	public static double calculateSingleMove_score(Point myMove, int player) { // 한 수의 점수 최대값을 계산 
